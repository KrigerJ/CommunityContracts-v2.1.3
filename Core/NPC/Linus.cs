    ...
    public class LinusProfile
    {
        ...
        public static class LinusContract
        {
            ...
            public static async void OfferDetailedContract()
            {
                ...
                {
                    if (profile.BaseItem.Category == -79)
                    {
                        processingLine =
                    ...
                    {
                        processingLine =
                            T("LinusPreservesProductsJ", new { count = profile.ProcessorsOperated, quality = profile.QualityName, item = profile.PreparedItemName }) + "\n\n" +
                            T("LinusPackShipment");
                    }
                }
            ...
            public static void LinusIntroduction()
            {
                ...
                profile.ProcessorsOperated = CountProcessors(15);
